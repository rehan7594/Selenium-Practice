...
public class Facebook_SingUp {
	...
	public void singup() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver1.findElement(By.name("reg_email__")).sendKeys("rehansdm94@gmail.com");
		Thread.sleep(2000);
		driver1.findElement(By.name("reg_email_confirmation__")).sendKeys("rehansdm94@gmail.com");
		Thread.sleep(2000);
		driver1.findElement(By.name("reg_passwd__")).sendKeys("rehan123");
		Thread.sleep(2000);
		...
		d_Dropdown.selectByVisibleText("7");
		m_Dropdown.selectByVisibleText("May");
		y_Dropdown.selectByVisibleText("1994");
		Thread.sleep(2000);
