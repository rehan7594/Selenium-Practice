...
public class WebElement_Interface_Methods {
	...
	public void RemoveElementFromTextBox() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("againEnteredRehan");
		Thread.sleep(2000);
//		 driver.findElement(By.xpath("//input[@type='text']")).sendKeys(Keys.CONTROL+"a"+Keys.DELETE);  
	...
	public void DeleteWothoutUsingClear() throws InterruptedException {
		...
		driver.manage().window().maximize();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("rehan");
		Thread.sleep(2000);
		String value = driver.findElement(By.xpath("//input[@type='text']")).getAttribute("value");
		System.out.println("Value present inside the text box is : "+value);
		driver.findElement(By.xpath("//input[@type='text']")).clear();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("rehankumar");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys(Keys.CONTROL+"a"+Keys.DELETE);
		Thread.sleep(2000);
		}
...
//		driver.close();
	...
	public void getAttribute() throws InterruptedException{
		...
		driver.manage().window().maximize();
		Thread.sleep(2000);
		String elementType = driver.findElement(By.xpath("//input[@type='text']")).getAttribute("rehan@gmail.com");
